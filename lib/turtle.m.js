...
var _marked =
/*#__PURE__*/
_regeneratorRuntime.mark(genF);

function genF(x) {
  var y;
  return _regeneratorRuntime.wrap(function genF$(_context) {
    while (1) {
...
MyPromise.prototype.then = function (onSuccess, onFail) {
  ...
  return new MyPromise(function (resolve, reject) {
    ...
    if (_this2.state === "resolved") {
      wrapCall(_this2.value, onSuccess, successCallback, failCallback);
    }

    if (_this2.state === "rejected") {
      wrapCall(_this2.value, onFail, successCallback, failCallback);
    }
  });
};
    ...
    function checkResult() {
      if (successNum + failNum === tasks.length) {
        if (successNum === tasks.length) {
          resolve.apply(void 0, result);
        } else {
          reject.apply(void 0, result);
        }
      }
    }
  });
...
export { DomUtil, EventBus, LazyMan, LazyManAsync, MyPromise, Schedule, Singleton, array, asyncUtil, buildTree, emca, genUtil, retryAjax, travelMiddlerOrder, util };
