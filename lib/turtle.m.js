...
var myInstance = function () {
  ...
  return {
    // public interface
    publicMethod1: function publicMethod1() {// all private members are accesible here
    },
    publicMethod2: function publicMethod2() {}
  };
}();
...
export { DomUtil, EventBus, LazyMan, LazyManAsync, MyPromise, Schedule, array, asyncUtil, buildTree, emca, myInstance, retryAjax, travelMiddlerOrder, util };
